...
import { Code, Database, Layout, Cpu, Users } from "lucide-react";
...
const skillCategories = [
  ...
  },
  {
    ...
    icon: <Database />,
    skills: ["Node.js", "Express", "Spring Boot", "Firebase", "MongoDB", "PostgreSQL"],
    gradient: "linear-gradient(137deg, #4361EE 0%, #E0AEFF 45%, #F72585 100%)",
  },
  {
    title: "Ecosystem",
    icon: <Cpu />,
    skills: ["Git / GitHub", "Vite", "Docker", "Postman", "CI/CD Foundations"],
